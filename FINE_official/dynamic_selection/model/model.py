...
def transform(**module_args):
    
    print(module_args)
    config = CONFIGS[module_args["model_type"]]
    del module_args["model_type"]
    pretrained = module_args["pretrained"]
    del module_args["pretrained"]
    model = VisionTransformer(config=config, **module_args)
