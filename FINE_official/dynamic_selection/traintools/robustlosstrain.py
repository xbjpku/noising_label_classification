...
def robustlosstrain(parse, config: ConfigParser):
    ...
    data_loader = module_data.CUBDataLoader(
...
#         validation_split=config['data_loader']['args']['validation_split'],
    ...
    lr_scheduler = WarmupCosineSchedule(optimizer, warmup_steps=config["lr_scheduler"]["warmup"], t_total= 10000)#config.initialize('lr_scheduler', torch.optim.lr_scheduler, optimizer)
